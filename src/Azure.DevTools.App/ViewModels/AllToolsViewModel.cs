...
public class AllToolsViewModel : ObservableRecipient, INavigationAware
{
    ...
    public AllToolsViewModel(INavigationService navigationService, ISampleDataService sampleDataService)
    {
    ...
    private void OnItemClick(SampleOrder clickedItem)
    {
        if (clickedItem != null)
        {
            ...
            _navigationService.NavigateTo(typeof(AllToolsDetailViewModel).FullName, clickedItem.OrderID);
        }
    }
}
